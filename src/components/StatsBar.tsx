...
import { fadeInUp, metricAnimation } from '../utils/animations';
...
interface StatsBarProps {
  ...
  deposits: number;
  profitLoss: number;
  initialBalance: number; // Added
  roi: number; // Added
}

function StatsBar({ winRate, trades, withdrawals, equity, deposits, profitLoss, initialBalance, roi }: StatsBarProps) {
    ...
    >
      ...
      <div className="bg-[#1A1A1A] rounded-lg p-6">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h3 className="text-sm text-gray-400">Account Summary</h3>
        </div>
        ...
        <div className="grid gap-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-[#252525] rounded-lg p-4">
              <span className="text-sm text-gray-400 block mb-2">Deposits</span>
              <div className="text-lg font-semibold text-green-400">+${deposits.toLocaleString()}</div>
            </div>
            <div className="bg-[#252525] rounded-lg p-4">
              <span className="text-sm text-gray-400 block mb-2">Withdrawn</span>
      ...
      <div className="bg-[#1A1A1A] rounded-lg p-6">
        ...
        <div className="grid gap-6">
          ...
          <div className="bg-[#252525] rounded-lg p-4">
            ...
            <div className="text-xl font-semibold text-blue-400">{roi.toFixed(2)}%</div>
          </div>
